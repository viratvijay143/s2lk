...
- These are the minimum required vars need to setup to make Dns Music Bot functional.
...
7. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@DnsStringBot](http://t.me/DnsStringBot) in Telegram.
...
- You can play tracks or playlists from spotify from Dns Music bot
...
- If you plan to use Dns Music Bot with your own customized or modified code.
...
- You can change images which are used in Dns Music Bot.
- You can generate telegaph links from [@DnsTelegraphBot](http://t.me/DnsTelegraphBot) and use it here.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [@DnsStringBot](http://t.me/DnsStringBot) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [@DnsStringBot](http://t.me/DnsStringBot) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [@DnsStringBot](http://t.me/DnsStringBot) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [@DnsStringBot](http://t.me/DnsStringBot) in Telegram.
